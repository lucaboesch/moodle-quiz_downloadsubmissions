...
/**
 * Behat quiz_downloadsubmissions related steps definitions.
 *
...
/**
 * Step definitions related to quiz_downloadsubmissions.
 */
class behat_quiz_downloadsubmissions extends behat_question_base {
    ...
    protected function resolve_page_url(string $page): moodle_url {
        switch ($page) {
            default:
                throw new Exception('Unrecognised quiz_downloadsubmissions page type "' . $page . '."');
        }
    }
     ...
     * | Report            | Quiz name    | The report page (mod/quiz/report.php?mode=downloadsubmissions) |
     *
    ...
    protected function resolve_page_instance_url(string $type, string $identifier): moodle_url {
        ...
        switch ($type) {
            case 'Download essay submissions':
                return new moodle_url('/mod/quiz/report.php',
                    ['id' => $this->get_cm_by_quiz_name($identifier)->id, 'mode' => 'downloadsubmissions']);

            default:
                throw new Exception('Unrecognised quiz_downloadsubmissions page type "' . $type . '".');
        }
    }
     ...
     *
     * @Given /^I confirm the quiz submission in the modal dialog for the quiz_downloadsubmissions plugin$/
     * @throws Exception
     */
    public function i_confirm_the_quiz_submission_in_the_modal_dialog_for_the_quiz_downloadsubmissions_plugin() {
        global $CFG;
